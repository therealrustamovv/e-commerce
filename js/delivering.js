...
!(function () {
  ...
  Calendar.prototype.renderEvents = function (events, ele) {
    ...
    if (!events.length) {
      ...
      var span = createElement("span", "", "Product ");
...
!(function () {
  var data = [
    { eventName: "Ordered Product", calendar: "Work", color: "orange" },
    { eventName: "Ordered Product", calendar: "Work", color: "orange" },
    { eventName: "Ordered Product", calendar: "Work", color: "orange" },
    { eventName: "Ordered Product", calendar: "Work", color: "orange" },

    { eventName: "Ordered Product", calendar: "Sports", color: "blue" },
    { eventName: "Ordered Product", calendar: "Sports", color: "blue" },
    { eventName: "Ordered Product", calendar: "Sports", color: "blue" },
    { eventName: "Ordered Product", calendar: "Sports", color: "blue" },

    { eventName: "Ordered Product", calendar: "Kids", color: "yellow" },
    { eventName: "Ordered Product", calendar: "Kids", color: "yellow" },
    { eventName: "Ordered Product", calendar: "Kids", color: "yellow" },
    { eventName: "Ordered Product", calendar: "Kids", color: "yellow" },

    { eventName: "Ordered Product", calendar: "Other", color: "green" },
    { eventName: "Ordered Product", calendar: "Other", color: "green" },
    { eventName: "TOrdered Product", calendar: "Other", color: "green" },
    { eventName: "Ordered Product", calendar: "Other", color: "green" },
  ];
...
timeSlotsContainer.addEventListener("click", function (event) {
  ...
  if (clickedElement.classList.contains("time")) {
    var timeSlots = timeSlotsContainer.getElementsByClassName("time");
    for (var i = 0; i < timeSlots.length; i++) {
      timeSlots[i].classList.remove("selected");
    }

    clickedElement.classList.add("selected");
    let selectedTimeSlot = clickedElement.textContent.trim();
